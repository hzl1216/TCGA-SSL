...
def create_parser():
    ...
    parser.add_argument('--n-class', type=int, default=33,
                        help='classes of  data')
    ...
    parser.add_argument('--mixup-size', type=int, default=1)
    ...
    parser.add_argument('--semi', default=True,type=str2bool,
                        help='semi')
    parser.add_argument('--gpi', default=False,type=str2bool,
                        help='get_permutation_importance')
